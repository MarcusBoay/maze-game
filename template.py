# Sounds acquired/randomly generated by royalty free open license from https://www.bfxr.net
# all graphics credited to Rafaella G.
# Python 3.5.2
...
class Game(object):
    ...
    def startLoop(self):
        ...
        start_text = start_font.render("Select difficulty with (1) (2) or (3); click on 'no pressure' to select between timed or not timed modes; Press (s) to begin!", 0, [0,0,0])
        ...
        while 1:
            ...
            self.screen.blit(name_text, (260,230))
            self.screen.blit(name_text, (260,230))
            self.screen.blit(start_text, (20, 450))
